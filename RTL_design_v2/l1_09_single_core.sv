...
module l1_09_v2_single_coeff_bank #(
...
module l1_09_v2_single_section #(
    ...
    logic signed [MULT_W-1:0] prod_y1_a1;
    logic signed [MULT_W-1:0] prod_y2_a2;
    ...
    always_comb begin
        ...
        acc = sign_extend_prod(prod_x0_a2)
            ...
            - sign_extend_prod(prod_y1_a1)
            - sign_extend_prod(prod_y2_a2);
...
module l1_09_v2_single_cascade #(
    parameter int SECTION_COUNT   = SECTION_COUNT_DEFAULT,
    parameter int DATA_W          = DATA_WIDTH_DEFAULT,
    parameter int COEFF_W         = COEFF_WIDTH_DEFAULT,
    parameter int COEFF_FRAC_BITS = COEFF_FRAC_BITS_DEFAULT,
